...
const backgroundImages = [
  ...
  "https://images.unsplash.com/photo-1642531406277-33bc9531e33e?q=80&w=764&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
...
export default function HeroSection() {
  ...
  const bgImageVariants = {
    ...
    visible: (i) => ({
      ...
      x: 0,
      transition: {
        delay: i * 0.15, // Stagger appearance of background images
        duration: 1,
        ease: "easeOut",
      },
    }),
    ...
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 overflow-hidden">
      ...
      <div className="absolute inset-0 hidden md:flex z-0"> {/* hidden on small, flex on md and up */}
        {backgroundImages.map((imageUrl, index) => (
          <motion.div
            key={index}
            className="w-1/4 h-full bg-cover bg-center" // Each takes 1/4th width, covers full height
      ...
      <motion.div
        ...
        style={{ backgroundImage: `url(${backgroundImages[0]})` }} // Using the first image for mobile
      ...
      <div className="relative z-20 container mx-auto px-4 py-16 md:py-24 text-center"> {/* z-20 ensures content is on top */}
        ...
        >
          <motion.h1
            ...
            className="text-4xl md:text-8xl font-extrabold text-white leading-tight mb-4 md:mb-6 drop-shadow-lg" /* Adjusted text size for better mobile fit */
          >
            24/7 Emergency
          ...
          <motion.p
            variants={itemVariants}
            className="text-base md:text-xl text-white mb-8 md:mb-10 max-w-2xl mx-auto drop-shadow-md" /* Adjusted text size for better mobile fit */
          >
